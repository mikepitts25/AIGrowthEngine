...
| ✨ **Outreach Studio** | One click drafts a personalized, value-first reply or DM for any lead — powered by Claude when an API key is set, with solid templates as fallback. You review and send it yourself, keeping outreach authentic and within platform rules. |
...
With a key set, outreach drafts and social posts are generated by Claude and
personalized to each lead and your business profile. Without one, the app
falls back to built-in templates and everything still works.
